    ...
    <div className="col-md-6  border rounded">
      <form className="row g-3 ">
        <div className="col-md-4">
          <label htmlFor="origen" style={{fontWeight: "bold"}} className="form-label mt-2">Origen</label>
          <input type="text" className="form-control" id="origen" placeholder="Ej. Lima" required />
        </div>
        <div className="col-md-4">
          <label htmlFor="destino" style={{fontWeight: "bold"}} className="form-label mt-2">Destino</label>
          <input type="text" className="form-control" id="destino" placeholder="Ej. Cusco" required />
        </div>
        <div className="col-md-2">
          <label htmlFor="salida" style={{fontWeight: "bold"}} className="form-label mt-2">Salida</label>
          <input type="text" className="form-control" id="salida" placeholder="Ej. 12/01/2023" required />
        </div>
        <div className="col-md-2">
          <label htmlFor="retorno" style={{fontWeight: "bold"}} className="form-label mt-2">Retorno</label>
